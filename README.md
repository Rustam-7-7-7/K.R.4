...
Курсовая работа 4 - это проект, целью которого 
является: разработать сервис управления рассылками, администрирования и получения статистики.
## Установка:

Клонируйте репозиторий:
```
git clone https://github.com/Rustam-7-7-7/K.R.4.git
```
